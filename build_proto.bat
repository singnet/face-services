...
python -m grpc_tools.protoc -I. --python_out=. --grpc_python_out=. services\grpc\face_recognition.proto
python -m grpc_tools.protoc -I. --python_out=. --grpc_python_out=. services\grpc\face_alignment.proto
